...
public class DialogPlus {
    ...
    private Animation bgOutAnim;
    private Animation bgInAnim;
    ...
    DialogPlus(DialogPlusBuilder builder) {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.moe_dialog_base_container, decorView, false);
        rootView.setLayoutParams(builder.getOutmostLayoutParams());

        backgroundView = rootView.findViewById(R.id.dialogplus_background);
        backgroundView.setBackgroundResource(builder.getOverlayBackgroundResource());
        ...
        bgInAnim = AnimationUtils.loadAnimation(builder.getContext(), R.anim.moe_dialog_background_fade_in);
        bgOutAnim = AnimationUtils.loadAnimation(builder.getContext(), R.anim.moe_dialog_background_fade_out);
        bgOutAnim.setAnimationListener(new Animation.AnimationListener() {
            @Override
    ...
    public void dismiss() {
        ...
        backgroundView.startAnimation(bgOutAnim);
        isDismissing = true;
    }
    ...
    private void onAttached(View view) {
        ...
        backgroundView.startAnimation(bgInAnim);
