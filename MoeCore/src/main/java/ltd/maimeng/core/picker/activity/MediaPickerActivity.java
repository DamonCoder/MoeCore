 ...
 */
package ltd.maimeng.core.picker.activity;
...
import ltd.maimeng.core.picker.adapter.AlbumMediaAdapter;
import ltd.maimeng.core.picker.adapter.AlbumsAdapter;
import ltd.maimeng.core.picker.bean.Album;
import ltd.maimeng.core.picker.bean.AlbumCollection;
...
import ltd.maimeng.core.picker.fragment.MediaSelectionFragment;
import ltd.maimeng.core.picker.util.MediaStoreCompat;
import ltd.maimeng.core.picker.util.PathUtils;
import ltd.maimeng.core.picker.util.PhotoMetadataUtils;
import ltd.maimeng.core.picker.util.SingleMediaScanner;
import ltd.maimeng.core.picker.widget.AlbumsSpinner;
import ltd.maimeng.core.picker.widget.CheckRadioView;
import ltd.maimeng.core.picker.widget.IncapableDialog;
...
public class MediaPickerActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TypedArray ta = getTheme().obtainStyledAttributes(new int[]{R.attr.media_picker_album_element_color});
        ...
        mAlbumsSpinner.setPopupAnchorView(findViewById(R.id.media_picker_toolbar));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PREVIEW) {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
                MediaPickerActivity.this.revokeUriPermission(contentUri, Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private int countOverMaxSize() {
        ...
        for (int i = 0; i < selectedCount; i++) {
            MediaItem item = mSelectedCollection.asList().get(i);
    ...
    public void onAlbumLoad(final Cursor cursor) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                mAlbumsSpinner.setSelection(MediaPickerActivity.this, mAlbumCollection.getCurrentSelection());
