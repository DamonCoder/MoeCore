...
import ltd.maimeng.core.picker.bean.AlbumMediaCollection;
...
import ltd.maimeng.core.picker.util.UIUtils;
import ltd.maimeng.core.picker.widget.MediaGridInset;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        int spacing = getResources().getDimensionPixelSize(R.dimen.media_picker_media_grid_spacing);
