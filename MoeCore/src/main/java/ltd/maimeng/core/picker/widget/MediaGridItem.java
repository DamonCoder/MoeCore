...
import ltd.maimeng.core.ui.widget.SquareFrameLayout;

import androidx.recyclerview.widget.RecyclerView;

public class MediaGridItem extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.holder_picker_media_grid_item, this, true);
    ...
    public interface OnMediaGridClickListener {
        ...
        void onCheckViewClicked(CheckView checkView, MediaItem item, RecyclerView.ViewHolder holder);
    }
