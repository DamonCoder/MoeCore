...
import ltd.maimeng.core.BuildConfig;
import ltd.maimeng.core.picker.graphics.FastBitmapDrawable;
import ltd.maimeng.core.picker.util.IDisposable;
 ...
 * @author alessandro
 */
public abstract class ImageTouchBaseView extends ImageView implements IDisposable {
    ...
    /**
     * Use this to change the {@link ImageTouchBaseView#setDisplayType(DisplayType)} of
     * this View
     *
     * @author alessandro
     */
    ...
    public ImageTouchBaseView(Context context) {
        this(context, null);
    }

    public ImageTouchBaseView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageTouchBaseView(Context context, AttributeSet attrs, int defStyle) {
