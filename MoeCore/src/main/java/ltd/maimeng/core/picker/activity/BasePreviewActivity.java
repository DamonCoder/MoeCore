...
import ltd.maimeng.core.picker.adapter.PreviewPagerAdapter;
...
import ltd.maimeng.core.picker.fragment.PreviewItemFragment;
...
import ltd.maimeng.core.picker.util.Platform;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mCheckView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaItem item = mAdapter.getMediaItem(mPager.getCurrentItem());
    ...
    public void onPageSelected(int position) {
        ...
        if (mPreviousPos != -1 && mPreviousPos != position) {
            ...
            MediaItem item = adapter.getMediaItem(position);
            if (mSpec.countable) {
    ...
    protected void updateSize(MediaItem item) {
        if (item.isGif()) {
    ...
    private boolean assertAddSelection(MediaItem item) {
