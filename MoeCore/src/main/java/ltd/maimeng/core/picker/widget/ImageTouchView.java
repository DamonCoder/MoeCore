...
public class ImageTouchView extends ImageTouchBaseView {
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(ImageTouchView.this);
            }
        }
    };
    ...
    public class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            return ImageTouchView.this.onSingleTapConfirmed(e);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            return ImageTouchView.this.onScroll(e1, e2, distanceX, distanceY);
        }
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (delta > MIN_FLING_DELTA_TIME) {
                return ImageTouchView.this.onFling(e1, e2, velocityX, velocityY);
            } else {
                return false;
            }
        }
        ...
        @Override
        public boolean onSingleTapUp(MotionEvent e) {
            return ImageTouchView.this.onSingleTapUp(e);
        }
        ...
        public boolean onDown(MotionEvent e) {
            ...
            return ImageTouchView.this.onDown(e);
        }
    }
