 ...
 */
package ltd.maimeng.core.picker.widget;
...
public class CheckView extends View {
    ...
    private void init(Context context) {
        ...
        TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.media_picker_item_checkCircle_borderColor});
        int defaultColor = ResourcesCompat.getColor(getResources(), R.color.media_picker_item_checkCircle_borderColor, getContext().getTheme());
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.media_picker_item_checkCircle_backgroundColor});
            int defaultColor = ResourcesCompat.getColor(getResources(), R.color.media_picker_item_checkCircle_backgroundColor, getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
