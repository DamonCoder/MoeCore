...
import ltd.maimeng.core.picker.bean.CaptureStrategy;
import ltd.maimeng.core.picker.bean.SelectionSpec;
import ltd.maimeng.core.picker.engine.ImageEngine;
import ltd.maimeng.core.picker.filter.MediaFilter;
import ltd.maimeng.core.picker.listener.OnCheckedListener;
import ltd.maimeng.core.picker.listener.OnSelectedListener;
...
public final class SelectionCreator {
    private final MediaPicker mMatisse;
     ...
     */
    SelectionCreator(MediaPicker matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator addFilter(@NonNull MediaFilter filter) {
