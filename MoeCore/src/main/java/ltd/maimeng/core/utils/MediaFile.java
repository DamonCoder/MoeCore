...
public class MediaFile {
    ...
    public static final int FILE_TYPE_MS_WORD_X = 108;
    public static final int FILE_TYPE_MS_EXCEL = 105;
    public static final int FILE_TYPE_MS_POWERPOINT = 106;
    public static final int FILE_TYPE_ZIP = 107;

    public static final int FILE_TYPE_MARKDOWN = 201;
    ...
    static {
        ...
        addFileType("DOCX", FILE_TYPE_MS_WORD_X, "application/msword");
        ...
        addFileType("MD", FILE_TYPE_MARKDOWN, "markdown/marketdown");
    }
    ...
    public static boolean isDOCFileType(int fileType) {
        return ((fileType == FILE_TYPE_MS_WORD) || (fileType == FILE_TYPE_MS_WORD_X));
    }
    ...
    /**
     * check is MarkDown or not
     *
     * @param fileType file type integer value
     * @return if is image type , return true ; otherwise , return false ;
     */
    public static boolean isMarkdownFileType(int fileType) {
        return (fileType == FILE_TYPE_MARKDOWN);
    }
